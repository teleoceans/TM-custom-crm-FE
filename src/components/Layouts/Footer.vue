<template>
  ...
  <footer
    ...
    <div class="mb-4 md:mb-0 xl:flex xl:items-center xl:space-x-3">
      <p class="mb-4 text-center text-sm text-gray-500 dark:text-gray-400 xl:mb-0">&copy; 2025 <a
          href="https://flowbite.com/" class="hover:underline" target="_blank">Flowbite</a>. All rights reserved.
      </p>
    ...
    <div class="flex items-center justify-center space-x-3">
      <button id="dropdownLanguageButton" data-dropdown-toggle="dropdownLanguage"
        ...
        <svg aria-hidden="true" class="me-2 ms-1.5 h-3 w-4" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-us"
          viewBox="0 0 512 512">
          <g fill-rule="evenodd">
            <g stroke-width="1pt">
              <path fill="#bd3d44"
        ...
        English (US)
        <svg class="mx-1.5 h-2.5 w-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
          viewBox="0 0 10 6">
          ...
          <li>
            <a href="#"
              ...
              <div class="inline-flex items-center">
                <svg aria-hidden="true" class="me-2 h-3.5 w-3.5 rounded-full" xmlns="http://www.w3.org/2000/svg"
